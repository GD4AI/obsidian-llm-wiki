...
function renderHowToUseSection(): string {
  return [
    ...
    '| `Karpathy LLM Wiki: View operation history` | Opens a panel listing what each previous Ingest call created/updated. |',
...
function renderQuickStartSection(): string {
  return [
    ...
    '2. **Wait for ingest to finish.** Each note takes 10–60 seconds (LLM extraction). You can keep working — completions appear as Notices. `View operation history` lists every batch\'s result.',
