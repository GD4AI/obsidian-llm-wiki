export const ZH_TEXTS = {
    ...
    wikiIngestedMarkerFailed: '无法为「{filename}」写入 wiki-ingested 标记。摄入已成功，但之后再次运行不会被跳过——请使用强制重新摄入或手动补写该标记。',
    wikiIngestedMarkerRepaired: '[LLM Wiki] 启动修复：已为 {count} 篇已摄入笔记补写 wiki-ingested 标记。',
